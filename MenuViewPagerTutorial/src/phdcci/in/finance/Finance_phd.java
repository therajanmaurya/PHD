...
public class Finance_phd extends SherlockFragment {
...
private class xfuck extends AsyncTask<Void, Void, Void>{
	...
	protected void onPostExecute(Void result) {
		...
		adp = new EventAdapterr(getActivity(),options,GetContacts.contactList2, GetContacts.contactList);
...
class EventAdapterr extends BaseExpandableListAdapter {
	Context context;
	Typeface type;
	...
	public EventAdapterr(Context context, DisplayImageOptions options,
